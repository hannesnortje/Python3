...
class VersionUpgradeApp(QWidget):
    ...
    @typechecked
    def upgrade_folders(self, path: str, old_version: str, new_version: str, max_depth: int) -> None:
        """
    ...
    @typechecked
    def upgrade_specific_subdirectories(self, folder_path: str, old_version: str, new_version: str) -> None:
        """
    ...
    @typechecked
    def update_dir_files(self, dir_path: str, old_version: str, new_version: str, file_extension: str) -> None:
        """
    ...
    @typechecked
    def replace_js_version(self, content: str, old_version: str, new_version: str) -> str:
        """
